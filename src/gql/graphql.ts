...
export type CategoriesGetListQuery = { categories: Array<{ id: string, name: string, slug: string, products: Array<{ id: string }> }> };
...
export type CollectionsGetListQuery = { collections: Array<{ id: string, slug: string, name: string, image: { id: string, url: string } }> };
...
export type ProductGetByIdQuery = { product?: { id: string, name: string, slug: string, description: string, price: number, variants: Array<{ id: string, name: string } | {}>, categories: Array<{ name: string }>, images: Array<{ url: string }> } | null };
...
export type ProductsGetListBySearchQuery = { products: Array<{ id: string, name: string, slug: string, description: string, price: number, categories: Array<{ name: string }>, images: Array<{ url: string }> }> };
...
export type CategoryItemFragment = { id: string, name: string, slug: string, products: Array<{ id: string }> };

export type CollectionListItemFragment = { id: string, slug: string, name: string, image: { id: string, url: string } };

export type ProductItemFragment = { id: string, name: string, slug: string, description: string, price: number, variants: Array<{ id: string, name: string } | {}>, categories: Array<{ name: string }>, images: Array<{ url: string }> };
...
export const ProductsGetListBySlugDocument = new TypedDocumentString(`
  ...
  price
}`) as unknown as TypedDocumentString<ProductsGetListBySlugQuery, ProductsGetListBySlugQueryVariables>;